...
describe('#'+NS, function() {
    ...
    before(function() {
        ...
        .then(function() {
            ...
            return businessNetworkConnection.connectWithDetails('defaultProfile', 'nestlesupplychain-network', 'admin', 'Xurw3yU9zI0l');
        });
    });
    ...
    describe('ChangeAssetValue()', function() {
        ...
        it('should change the value property of ' + assetType + ' to newValue', () => {
            ...
            // create a user
            var user = factory.newResource(NS, 'User', 'kelvin');
